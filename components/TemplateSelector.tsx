...
import { templates, Template, loadTemplate } from '@/lib/templates'
...
export default function TemplateSelector({ onTemplateSelect, currentTemplate }: TemplateSelectorProps) {
  ...
  return (
    <div className="template-selector">
      ...
      {isOpen && <div className="template-overlay" onClick={() => setIsOpen(false)}></div>}
    </div>
  );
}